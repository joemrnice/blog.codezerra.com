...
<head>
    ...
    <title>About - <?php echo escape($siteTitle); ?></title>
    <meta name="description" content="Learn more about <?php echo escape($siteTitle); ?> and our mission">
...
<body class="bg-gray-50">
    ...
    <section class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div class="bg-white rounded-lg shadow-md p-8">
            <h2 class="text-3xl font-bold text-gray-900 mb-6">Welcome to <?php echo escape($siteTitle); ?></h2>
            
            <div class="prose max-w-none text-gray-700 space-y-4">
                <p class="text-lg">
                    <?php echo escape($siteTitle); ?> is your go-to resource for insightful articles, tutorials, 
                    and discussions on web development, programming, and technology trends.
                </p>
                
                <h3 class="text-2xl font-bold text-gray-900 mt-8 mb-4">Our Mission</h3>
                <p>
                    We are dedicated to sharing knowledge and helping developers at all levels grow their skills. 
                    Whether you're just starting your coding journey or you're a seasoned professional, 
                    we have content that will inspire and educate you.
                </p>
                
                <h3 class="text-2xl font-bold text-gray-900 mt-8 mb-4">What We Cover</h3>
                <ul class="list-disc list-inside space-y-2">
                    ...
                    <li>Latest Technology Trends and News</li>
                </ul>
                
                <h3 class="text-2xl font-bold text-gray-900 mt-8 mb-4">Get In Touch</h3>
                <p>
                    Have questions, suggestions, or want to contribute? We'd love to hear from you! 
                    <a href="/contact.php" class="text-blue-600 hover:text-blue-800 font-medium">Contact us</a> 
