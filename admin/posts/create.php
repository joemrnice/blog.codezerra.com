                    ...
                    <div class="bg-white rounded-lg shadow p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="slug" name="slug" required
                                   value="<?php echo escape($formData['slug'] ?? ''); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                            <p class="text-sm text-gray-500 mt-1">Auto-generated from title. Edit if needed.</p>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="content" name="content" rows="15" required
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"><?php echo escape($formData['content'] ?? ''); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea id="excerpt" name="excerpt" rows="3"
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                      placeholder="Optional short description..."><?php echo escape($formData['excerpt'] ?? ''); ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="bg-white rounded-lg shadow p-6 space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input type="text" id="featured_image" name="featured_image"
                                       value="<?php echo escape($formData['featured_image'] ?? ''); ?>"
                                       class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        ...
                        <div>
                            ...
                            <input type="datetime-local" id="published_at" name="published_at"
                                   value="<?php echo escape($formData['published_at'] ?? ''); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent">
                                ...
                                <?php foreach ($categories as $category): ?>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="categories[]" value="<?php echo $category['id']; ?>"
                                               <?php echo in_array($category['id'], $formData['categories'] ?? []) ? 'checked' : ''; ?>
                                ...
                                <?php foreach ($tags as $tag): ?>
                                    <label class="flex items-center space-x-2 p-2 border border-gray-200 rounded hover:bg-gray-50 cursor-pointer">
                                        <input type="checkbox" name="tags[]" value="<?php echo $tag['id']; ?>"
                                               <?php echo in_array($tag['id'], $formData['tags'] ?? []) ? 'checked' : ''; ?>
                                               class="rounded text-purple-600 focus:ring-purple-500">
                    ...
                    <div class="bg-white rounded-lg shadow p-6 space-y-6">
                        ...
                        <div>
                            ...
                            <input type="text" id="meta_title" name="meta_title"
                                   value="<?php echo escape($formData['meta_title'] ?? ''); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        ...
                        <div>
                            ...
                            <textarea id="meta_description" name="meta_description" rows="2"
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                      placeholder="SEO description (optional)"><?php echo escape($formData['meta_description'] ?? ''); ?></textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="og_image" name="og_image"
                                   value="<?php echo escape($formData['og_image'] ?? ''); ?>"
                                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                        ...
                        <div>
                            ...
                            <textarea id="og_description" name="og_description" rows="2"
                                      class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                                      placeholder="Social media description (optional)"><?php echo escape($formData['og_description'] ?? ''); ?></textarea>
                        </div>
                    </div>
